...
public class ModLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModBlocks.WHITE_DRYWALL, "White Drywall");
        translationBuilder.add(ModBlocks.WHITE_DRYWALL_STAIRS, "White Drywall Stairs");
        translationBuilder.add(ModBlocks.WHITE_DRYWALL_SLAB, "White Drywall Slab");
        translationBuilder.add(ModBlocks.WHITE_DRYWALL_WALL, "White Drywall Wall");
        translationBuilder.add(ModBlocks.BROWN_DRYWALL, "Brown Drywall");
        translationBuilder.add(ModBlocks.BROWN_DRYWALL_STAIRS, "Brown Drywall Stairs");
        translationBuilder.add(ModBlocks.BROWN_DRYWALL_SLAB, "Brown Drywall Slab");
        translationBuilder.add(ModBlocks.BROWN_DRYWALL_WALL, "Brown Drywall Wall");
        translationBuilder.add(ModBlocks.TAN_DRYWALL, "Tan Drywall");
        translationBuilder.add(ModBlocks.TAN_DRYWALL_STAIRS, "Tan Drywall Stairs");
        translationBuilder.add(ModBlocks.TAN_DRYWALL_SLAB, "Tan Drywall Slab");
        translationBuilder.add(ModBlocks.TAN_DRYWALL_WALL, "Tan Drywall Wall");
        translationBuilder.add(ModBlocks.RED_DRYWALL, "Red Drywall");
        translationBuilder.add(ModBlocks.RED_DRYWALL_STAIRS, "Red Drywall Stairs");
        translationBuilder.add(ModBlocks.RED_DRYWALL_SLAB, "Red Drywall Slab");
        translationBuilder.add(ModBlocks.RED_DRYWALL_WALL, "Red Drywall Wall");
        translationBuilder.add(ModBlocks.ORANGE_DRYWALL, "Orange Drywall");
        translationBuilder.add(ModBlocks.ORANGE_DRYWALL_STAIRS, "Orange Drywall Stairs");
        translationBuilder.add(ModBlocks.ORANGE_DRYWALL_SLAB, "Orange Drywall Slab");
        translationBuilder.add(ModBlocks.ORANGE_DRYWALL_WALL, "Orange Drywall Wall");
        translationBuilder.add(ModBlocks.YELLOW_DRYWALL, "Yellow Drywall");
        translationBuilder.add(ModBlocks.YELLOW_DRYWALL_STAIRS, "Yellow Drywall Stairs");
        translationBuilder.add(ModBlocks.YELLOW_DRYWALL_SLAB, "Yellow Drywall Slab");
        translationBuilder.add(ModBlocks.YELLOW_DRYWALL_WALL, "Yellow Drywall Wall");
        translationBuilder.add(ModBlocks.LIME_DRYWALL, "Lime Drywall");
        translationBuilder.add(ModBlocks.LIME_DRYWALL_STAIRS, "Lime Drywall Stairs");
        translationBuilder.add(ModBlocks.LIME_DRYWALL_SLAB, "Lime Drywall Slab");
        translationBuilder.add(ModBlocks.LIME_DRYWALL_WALL, "Lime Drywall Wall");
        translationBuilder.add(ModBlocks.TURQUOISE_DRYWALL, "Turquoise Drywall");
        translationBuilder.add(ModBlocks.TURQUOISE_DRYWALL_STAIRS, "Turquoise Drywall Stairs");
        translationBuilder.add(ModBlocks.TURQUOISE_DRYWALL_SLAB, "Turquoise Drywall Slab");
        translationBuilder.add(ModBlocks.TURQUOISE_DRYWALL_WALL, "Turquoise Drywall Wall");
        translationBuilder.add(ModBlocks.BLUE_DRYWALL, "Blue Drywall");
        translationBuilder.add(ModBlocks.BLUE_DRYWALL_STAIRS, "Blue Drywall Stairs");
        translationBuilder.add(ModBlocks.BLUE_DRYWALL_SLAB, "Blue Drywall Slab");
        translationBuilder.add(ModBlocks.BLUE_DRYWALL_WALL, "Blue Drywall Wall");
        translationBuilder.add(ModBlocks.INDIGO_DRYWALL, "Indigo Drywall");
        translationBuilder.add(ModBlocks.INDIGO_DRYWALL_STAIRS, "Indigo Drywall Stairs");
        translationBuilder.add(ModBlocks.INDIGO_DRYWALL_SLAB, "Indigo Drywall Slab");
        translationBuilder.add(ModBlocks.INDIGO_DRYWALL_WALL, "Indigo Drywall Wall");
        translationBuilder.add(ModBlocks.PURPLE_DRYWALL, "Purple Drywall");
        translationBuilder.add(ModBlocks.PURPLE_DRYWALL_STAIRS, "Purple Drywall Stairs");
        translationBuilder.add(ModBlocks.PURPLE_DRYWALL_SLAB, "Purple Drywall Slab");
        translationBuilder.add(ModBlocks.PURPLE_DRYWALL_WALL, "Purple Drywall Wall");
        translationBuilder.add(ModBlocks.MAGENTA_DRYWALL, "Magenta Drywall");
